...
SimpleComplete.storyName = 'Base AutoComplete'

export const CustomComplete = (args: any) => {
...
CustomComplete.storyName = 'Custom AutoComplete'

export const AsyncComplete = (args: any) => {
  const handleFetch = (query: string) => {
...
AsyncComplete.storyName = 'Async AutoComplete'
