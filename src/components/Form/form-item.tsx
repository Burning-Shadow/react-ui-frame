...
export const FormItem: FC<FormItemProps> = (props) => {
  const {
    ...
    valuePropName,
    trigger,
    getValueFromEvent, // e.target.value 不一定能取到值【例如 checkbox 即为 checked】
    rules,
    validateTrigger,
  ...
  const rowClass = classNames('ant-row', {
    'ant-row-no-label': !label,
  });
  useEffect(() => {
  ...
  const itemClass = classNames('ant-form-item-control', {
