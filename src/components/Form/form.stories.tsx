...
export const BasicForm = (args: any) => {
  return (
    <Form {...args} >
      ...
      <div className='ant-form-submit-area'>
        <Button type="submit" btnType='primary'>登陆</Button>
      </div>
    </Form>
  );
};
BasicForm.storyName = 'Base LoginForm';
...
RegForm.storyName = 'Registration form, supporting a variety of FormItem components';
...
export const FullForm = (args: any) => {
  ...
  return (
    <Form initialValues={{ username: 'ant', agreement: false }} {...args} ref={ref}>
...
FullForm.storyName = 'Custom Rules';
